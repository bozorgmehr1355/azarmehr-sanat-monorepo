...
پاسخ: «متشکریم که موضوع را با ما در میان گذاشتید. در این محصول ضمانت بازگشت وجه در نظر گرفته شده است. همچنین همه خریداران ۷ گرم چای مهمان عقرب هستند و داخل جعبه یک نمونه رایگان ۷ گرمی قرار دارد. لطفاً بفرمایید: ۱) آیا فقط از نمونه ۷ گرمی استفاده کرده‌اید؟ ۲) آیا پاکت اصلی چای باز نشده است؟ ۳) چای را تقریباً با چه روشی دم کرده‌اید؟»

**مرحله ۲ - بررسی شرایط:**
اگر پاکت اصلی باز شده → «بر اساس شرایط، ضمانت بازگشت وجه زمانی قابل استفاده است که فقط از نمونه استفاده شده باشد و پاکت اصلی باز نشده باشد. از آنجا که پاکت باز شده، این مورد مشمول بازگشت وجه نیست. خوشحال می‌شویم راهنمایی دم‌آوری کنیم.»
اگر فقط نمونه استفاده شده و پاکت باز نشده → واجد شرایط است → برو مرحله ۳

**مرحله ۳ - بررسی روش دم‌آوری:**
بپرس: «برای ۷ گرم نمونه چه مقدار آب استفاده کردید؟ آب در چه مرحله‌ای بود؟ چند دقیقه دم دادید؟ طعم کم‌رنگ بود، تلخ بود یا عطر نداشت؟»
...
«حتماً. لطفاً برای ثبت در بخش گارانتی، این اطلاعات را ارسال بفرمایید: نام و نام خانوادگی، شماره تماس، نام محصول، آدرس کامل، کدپستی، شهر و استان، علت درخواست، تأیید استفاده فقط از نمونه ۷ گرمی و باز نشدن پاکت اصلی.»
