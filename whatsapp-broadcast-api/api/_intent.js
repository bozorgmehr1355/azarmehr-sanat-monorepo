...
const PRODUCT_QUERY_KEYWORDS = [
  ...
  'چای', 'دارین', 'هستن',
  // توجه: 'فروش', 'قیمت', 'سفارش', 'خرید' از اینجا حذف شدند
  // چون intent اختصاصی خودشان را دارند (PRICE_QUERY, ORDER)
  // و باعث تداخل در ambigutiy gate می‌شدند
];
...
اینستاگرام: ${INSTAGRAM}`;
  ...
  const REPLIES = {
    GREETING: `سلام! به فروشگاه محصولات غذایی عقرب خوش آمدید.
...
${SUPPORT}`,
    ...
    WARRANTY_QUERY: `ضمانت بازگشت وجه برای دو محصول عقرب فعال است:

۱) محصولات مشمول:
چای شکسته زرین ۵۰۰ گرمی و چای باروتی زرین ۵۰۰ گرمی

۲) شرایط استفاده:
فقط از نمونه ۷ گرمی داخل جعبه استفاده شده باشد و پاکت اصلی باز نشده باشد

۳) نکته مهم:
همه خریداران ۷ گرم چای مهمان عقرب هستند — نمونه ۷ گرمی رایگان داخل جعبه است

۴) مراحل اقدام:
اگر شرایط را دارید، لطفاً روش دم‌آوری خود را توضیح دهید تا راهنمایی کنیم`,
